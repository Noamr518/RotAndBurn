...
public class BlueberryBushBlock extends PlantBlock implements Fertilizable {
    ...
    private static final float MIN_MOVEMENT_FOR_DAMAGE = 0.02F;
    ...
    public ItemStack getPickStack(WorldView world, BlockPos pos, BlockState state) {
        return new ItemStack(ModBlocks.BLUEBERRY_BUSH);
    }
    ...
    protected VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        if ((Integer)state.get(AGE) == 0) {
            ...
            return state.get(AGE) < 3 ? LARGE_SHAPE.offset(vec3d.x, vec3d.y, vec3d.z) : super.getOutlineShape(state, world, pos, context);
        }
    }

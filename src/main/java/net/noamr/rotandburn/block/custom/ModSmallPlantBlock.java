...
public class ModSmallPlantBlock extends PlantBlock implements Fertilizable {
    public ModSmallPlantBlock(Settings settings) {
        super(settings);
    }
    ...
    protected static final VoxelShape SHAPE = Block.createCuboidShape(2.0, 1.0, 2.0, 14.0, 8.0, 14.0);

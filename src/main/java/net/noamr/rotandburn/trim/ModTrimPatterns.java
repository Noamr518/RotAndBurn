...
public class ModTrimPatterns {
        public static final RegistryKey<ArmorTrimPattern> RUIN = RegistryKey.of(RegistryKeys.TRIM_PATTERN,
                Identifier.of(RotAndBurn.MOD_ID, "ruin"));

        public static void bootstrap(Registerable<ArmorTrimPattern> context) {
            register(context, ModItems.RUIN_TRIM, RUIN);
        }
